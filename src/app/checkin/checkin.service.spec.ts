...
describe('CheckinService', () => {
  ...
  it('SelectedPassenger() should store data', () => {
    service.SelectedPassenger(flight.passengers[0]);
    expect(service.selectedPassenger).toBe(flight.passengers[0])
  });


  it('getSelectedPassenger() should return data', () => {
    service.selectedPassenger = flight.passengers[0];
    expect(service.getSelectedPassenger()).toBe(flight.passengers[0]);
  });
